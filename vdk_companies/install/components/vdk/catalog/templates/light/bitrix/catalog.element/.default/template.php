...
<div class="catalog-element">
		...
		<?endif;?>
			<td width="100%" valign="top">
				<?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
						...
						<?=$arProperty["NAME"]?>:&nbsp;<b><?=strip_tags($arProperty["DISPLAY_VALUE"]);?></b><br /> 
						...
						<?=$arProperty["NAME"]?>:&nbsp;<a href="/club/user/<?=$ID_USER;?>/" target="_blank"><?=$NAME_USER;?></a><br /> 
 						<?elseif ($arProperty["CODE"] =="vdk_map"):?>
						<?elseif ($arProperty["CODE"] =="vdk_url"):?>
						<?=str_replace("href"," target='blank' href",$arProperty["DISPLAY_VALUE"])?><br /> 
	...
	<?if($arResult["DETAIL_TEXT"]):?>
		<b>Подробное описание компании:</b><br /> <br /><?=$arResult["DETAIL_TEXT"]?><br />
	<?elseif($arResult["PREVIEW_TEXT"]):?>
		<br /><?=$arResult["PREVIEW_TEXT"]?><br />
	<?endif;?>
<br /><?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
						<?if ($arProperty["CODE"] =="vdk_map"):?>
							<?=$arProperty["NAME"]?>:<b>&nbsp;<?
					if(is_array($arProperty["DISPLAY_VALUE"])):
						echo implode("&nbsp;/&nbsp;", $arProperty["DISPLAY_VALUE"]);
					elseif($pid=="MANUAL"):
	...
	<?endif?>
<br /><br /><b style="font-size: 14px"><a href="/companies/">Посмотреть все компании</a></b>
</div>
