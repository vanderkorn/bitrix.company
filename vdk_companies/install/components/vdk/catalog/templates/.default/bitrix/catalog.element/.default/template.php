		...
		<?endif;?>
			<td width="100%" valign="top">
				<?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
						...
						<?=$arProperty["NAME"]?>:&nbsp;<a href="mailto:<?=$arProperty["VALUE"];?>" target="_blank"><?=$arProperty["VALUE"];?></a><br /> 
						...
						<?=$arProperty["NAME"]?>:&nbsp;<?=str_replace("href"," target='blank' href",$arProperty["DISPLAY_VALUE"])?><br /> 
...
?>
<br />Количество показов: <?=$arResult["SHOW_COUNTER"]?>
